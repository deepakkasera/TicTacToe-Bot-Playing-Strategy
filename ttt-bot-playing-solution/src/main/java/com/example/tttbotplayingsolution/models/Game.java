...
import com.example.tttbotplayingsolution.exceptions.GameInvalidationException;
...
import com.example.tttbotplayingsolution.strategies.WinningStrategyImpl;
...
public class Game {
    ...
    public void makeMove() throws InvalidMoveException, NoPossibleMoveForBotException {
